...
void loop() {
  ...
  while (1) { // reduces jitter
    ...
    Serial.print("TakeTotal: ");
    Serial.println(takeTotal());
    if ((takeTotal() < 35) && (timeInactive >= SCREENSAVER))
    {
      setScreenOff();
    }
    else if (takeTotal() < 35 && timeInactive < SCREENSAVER)
    {
      timeInactive++;
    }
    else
    ...
    */
    refresh();
    Serial.print("timeInactive: ");
    Serial.println(timeInactive);
    //delay(10000);
  }
}
